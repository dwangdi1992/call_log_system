...
import rma.org.bt.mms.model.DepositInfoDTO;
import rma.org.bt.mms.model.KiduInfoDTO;
import rma.org.bt.mms.model.LoanInfoDTO;
...
public class HomeController extends BaseController {
   ...
   /* @ResponseBody
    ...
    @ResponseBody
    @RequestMapping(value = "/getTotalKiduDisbursed", method = RequestMethod.GET)
    public List<KiduInfoDTO> getTotalKiduDisbursed() {
        return kiduService.getTotalKiduDisbursed();
    }

    @ResponseBody
    @RequestMapping(value = "/getDepositByBank", method = RequestMethod.GET)
    public List<KiduInfoDTO> getDepositByBank() {
        return financialInfoService.getDepositByBank();
    }

//    TODO need to again if needed.
    /*@ResponseBody
    @RequestMapping(value = "/getDepositByType", method = RequestMethod.GET)
    public KiduInfoDTO getDepositByType() {
        return financialInfoService.getDepositByType();
    }*/
    //endregion
    //endregion
}
